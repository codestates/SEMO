...
// qjastar a123456
export const useStoreTemp = create(
  devtools((set) => ({
    loginmodal: false,
    ...
    settoken: (a) =>
      set((state) => ({ token: (state.token = a) }), console.log(a)),
    ...
    setText: (a) =>
      set((state) => ({ text: (state.text = a) }), console.log(a)),
...
export const useUserinfo = create(
  devtools((set) => ({
    ...
    setUserNickname: (a) =>
      set(
        (state) => (
          { nickname: (state.nickname = a) },
          { nickname2: (state.nickname2 = a) }
        )
      ),
    setUserPassword: (a) =>
      set((state) => ({ password: (state.password = a) })),
